...
RSpec.feature "Listing Articles" do 
	...
	before do 
		...
		@article1 = Article.create(title: "The first article", body: "Lorem ipsum 1st.", user: @john)
		@article2 = Article.create(title: "The second article", body: "Lorem ipsum 2nd.", user: @john)
	end
